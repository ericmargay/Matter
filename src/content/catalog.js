...
export const DEVICES = [
  ...
  { id: 'orein-a19-matter', name: 'Foco A19 Matter (OS0100811267)', brand: 'OREIN', cat: 'iluminacion', link: 'matter', eco: ALL, power: 'corriente', price: [180, 280], tier: 'esencial', luz: { lm: 800, k: [2700, 6500], haz: 180, forma: 'punto' }, matter: { estado: 'fabrica', porque: 'Matter sobre WiFi de fábrica.' }, pitch: 'Foco Matter barato que entra directo a Apple, Google y Alexa sin puente ni app aparte.', detalle: 'Matter sobre WiFi: cada foco ocupa un lugar en la red. Con más de ocho conviene malla, que en este departamento ya la hay.' },
