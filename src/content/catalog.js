...
export const DEVICES = [
  ...
  { id: 'ultraloq-bolt', name: 'Ultraloq Bolt Mission', brand: 'U-tec', cat: 'acceso', link: 'thread', eco: ALL, power: 'pila', price: [2618, 3213], tier: 'casa', pitch: 'Abre con huella en menos de un segundo. También por código, por app o con llave.' },
  ...
  { id: 'tapo-tc70', name: 'Tapo TC70 · 360° interior', brand: 'TP-Link Tapo', cat: 'camaras', link: 'wifi', eco: ['alexa', 'google', 'ha'], power: 'corriente', price: [499, 499], tier: 'esencial', pitch: 'La cámara de interior con la que arranca cualquier casa: gira 360°, ve de noche y graba en la microSD sin pagar nube. Por lo que cuesta una cena.', detalle: 'WiFi 2.4 GHz, 1080p, giro y barrido completos desde el teléfono, visión nocturna y detección de movimiento con aviso al celular. Graba local en microSD —hasta 256 GB, que se compran aparte— así que no hay suscripción de por medio. NO habla Matter: la especificación de cámara todavía no aterriza en producto, así que va por su app y por Alexa o Google, no por Casa de Apple. Es cámara de interior: no se pone en patio ni en fachada.' },
