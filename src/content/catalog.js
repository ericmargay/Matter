...
export const DEVICES = [
  ...
  /* ── Sonoff ────────────────────────────────────────────────────
     ...
     toca todos los días. */
  { id: 'sonoff-zbmini-l2', name: 'ZBMINI L2 (sin neutro)', brand: 'Sonoff', cat: 'control', link: 'zigbee', eco: ALL, power: 'cableado', price: [320, 480], tier: 'esencial', pitch: 'El módulo que funciona en la caja del apagador que no tiene neutro, que es la mitad de las casas de la Ciudad de México. Se mete detrás de la placa y el apagador de siempre se queda donde está.', detalle: 'Zigbee, así que necesita puente —un Echo grande, un Echo Show o el puente de Sonoff—. Es la alternativa barata a abrir muro para tirar un neutro: donde eso cuesta días de obra, esto se resuelve en veinte minutos por apagador. Carga mínima: con focos LED muy chicos puede parpadear, y ahí se le pone un condensador o se cambia el foco.' },
  ...
  { id: 'sonoff-m5', name: 'SwitchMan M5 Matter', brand: 'Sonoff', cat: 'control', link: 'matter', eco: ALL, power: 'cableado', price: [620, 950], tier: 'esencial', pitch: 'Apagador de pared completo, con botón mecánico de verdad. Para cuando conviene cambiar la placa en vez de esconder un módulo.', detalle: 'Botón físico con clic: apaga y prende aunque se caiga el internet, que es la objeción número uno del cliente. Uno, dos o tres canales. Necesita neutro.' },
  ...
  { id: 'sonoff-nspanel-pro', name: 'NSPanel Pro', brand: 'Sonoff', cat: 'hubs', link: 'wifi', eco: ALL, power: 'cableado', price: [2200, 3200], tier: 'casa', pitch: 'Pantalla táctil de pared que además hace de puente Zigbee. Va donde iba el apagador del pasillo y se vuelve el tablero de la casa.', detalle: 'Reemplaza una placa doble. Controla escenas con el dedo sin sacar el teléfono, que es lo que hace que la casa se use de verdad. Como puente Zigbee ahorra comprar otro aparato.' },
  ...
  { id: 'sonoff-snzb-02p', name: 'SNZB-02P · temperatura', brand: 'Sonoff', cat: 'clima', link: 'zigbee', eco: ALL, power: 'pila', price: [190, 300], tier: 'esencial', pitch: 'Temperatura y humedad por cuarto, para que el minisplit y el humidificador se disparen con el dato y no con el reloj.' },
