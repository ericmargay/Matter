...
export const DEVICES = [
  ...
  { id: 'gas-detector-lp', name: 'Detector de gas LP', brand: 'Genérico', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'corriente', price: [450, 850], tier: 'esencial', pitch: 'Para casa con tanque o gas estacionario. Va A RAS DE PISO: el gas LP es más pesado que el aire y se acumula abajo.', detalle: 'OJO — no es intercambiable con el de gas natural. El LP (propano/butano, el del tanque) baja; el natural (metano, el de tubería) sube. Un detector puesto a la altura equivocada nunca se dispara, y eso es peor que no tenerlo porque da tranquilidad falsa. Sonoff no fabrica detectores de gas; se resuelve con Zigbee genérico y puente.' },
