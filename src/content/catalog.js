...
export const CATEGORIES = [
  ...
  { id: 'cableado', label: 'Cable y acomodo', hint: 'Multicontactos, extensiones, canaleta y lo que ordena lo que ya está' },
...
export const DEVICES = [
  ...
  { id: 'nanoleaf-triangles', name: 'Shapes Triángulos (kit 9)', brand: 'Nanoleaf', cat: 'iluminacion', link: 'thread', eco: ALL, power: 'corriente', price: [4000, 5200], tier: 'casa', luz: { lm: 900, k: [1200, 6500], haz: 120, forma: 'panel' }, pitch: 'Paneles triangulares que se arman en la pared como uno quiera. Más geométricos que los hexágonos y más fáciles de componer en diagonal.', detalle: 'Thread, así que además refuerzan la malla de la casa. Es de las pocas piezas donde no hay equivalente Sonoff: la marca no fabrica paneles decorativos, y las copias genéricas no hablan Matter ni Thread.' },
  ...
  { id: 'shelly-1mini', name: 'Shelly 1 Mini Gen4', brand: 'Shelly', cat: 'control', link: 'matter', eco: ALL, power: 'cableado', price: [440, 440], tier: 'esencial', pitch: 'Del tamaño de una moneda. Vuelve inteligente cualquier cosa que ya esté cableada: el boiler, el portón, la bomba.' },
  ...
  { id: 'aqara-th', name: 'Aqara Temp & Humidity', brand: 'Aqara', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'pila', price: [664, 664], tier: 'esencial', pitch: 'Mide temperatura y humedad de cada cuarto. Es el que hace que el extractor del baño prenda cuando de verdad hace falta.' },
  ...
  { id: 'ultraloq-bolt', name: 'Ultraloq Bolt Mission', brand: 'U-tec', cat: 'acceso', link: 'thread', eco: ALL, power: 'pila', price: [2975, 3570], tier: 'casa', pitch: 'Abre con huella en menos de un segundo. También por código, por app o con llave.' },
  ...
  { id: 'aqara-g5pro', name: 'Aqara Camera Hub G5 Pro', brand: 'Aqara', cat: 'camaras', link: 'wifi', eco: ALL, power: 'corriente', price: [4175, 4175], tier: 'casa', pitch: 'Cámara de exterior que además hace de cerebro para los sensores. Dos aparatos en uno, un solo enchufe.' },
  { id: 'tapo-tc70', name: 'Tapo TC70 · 360° interior', brand: 'TP-Link Tapo', cat: 'camaras', link: 'wifi', eco: ['alexa', 'google', 'ha'], power: 'corriente', price: [529, 529], tier: 'esencial', pitch: 'La cámara de interior con la que arranca cualquier casa: gira 360°, ve de noche y graba en la microSD sin pagar nube. Por lo que cuesta una cena.', detalle: 'WiFi 2.4 GHz, 1080p, giro y barrido completos desde el teléfono, visión nocturna y detección de movimiento con aviso al celular. Graba local en microSD —hasta 256 GB, que se compran aparte— así que no hay suscripción de por medio. NO habla Matter: la especificación de cámara todavía no aterriza en producto, así que va por su app y por Alexa o Google, no por Casa de Apple. Es cámara de interior: no se pone en patio ni en fachada.' },
  ...
  /* ── Sonoff ────────────────────────────────────────────────────
     Entra al catálogo por una razón concreta, no por completar marcas: es la
     única línea barata que resuelve el problema del apagador mexicano. En
     buena parte de las casas de la CDMX la caja del apagador NO tiene neutro
     —se cableó solo la fase— y ahí ningún módulo normal funciona. El ZBMINI
     L2 sí, y cuesta una fracción de lo que cuesta abrir muro para meter un
     cable. Lo demás de la marca acompaña: dimmer, cortina, medición y panel.

     El compromiso hay que decirlo: Sonoff no es Hue. La terminación es de
     plástico económico y el soporte es un foro. Va donde queda escondido
     —dentro de un registro, detrás de una placa— y no donde el cliente lo
     toca todos los días. */
  { id: 'sonoff-zbmini-l2', name: 'ZBMINI L2 (sin neutro)', brand: 'Sonoff', cat: 'control', link: 'zigbee', eco: ALL, power: 'cableado', price: [221, 221], tier: 'esencial', pitch: 'El módulo que funciona en la caja del apagador que no tiene neutro, que es la mitad de las casas de la Ciudad de México. Se mete detrás de la placa y el apagador de siempre se queda donde está.', detalle: 'Zigbee, así que necesita puente —un Echo grande, un Echo Show o el puente de Sonoff—. Es la alternativa barata a abrir muro para tirar un neutro: donde eso cuesta días de obra, esto se resuelve en veinte minutos por apagador. Carga mínima: con focos LED muy chicos puede parpadear, y ahí se le pone un condensador o se cambia el foco.' },
  { id: 'sonoff-minir4m', name: 'MINI R4M Matter', brand: 'Sonoff', cat: 'control', link: 'matter', eco: ALL, power: 'cableado', price: [372, 372], tier: 'esencial', pitch: 'El mismo truco pero hablando Matter directo: entra a Apple, Google y Alexa sin puente ni app aparte. Necesita neutro en la caja.', detalle: 'Matter sobre WiFi, no Thread — se conecta a la red de la casa como un aparato más. Con muchos módulos conviene tenerlo en cuenta para la carga del access point. Trae modo desacoplado: el apagador de pared queda como escena y la luz se controla aparte.' },
  { id: 'sonoff-mini-dim', name: 'MINI DIM · atenuador', brand: 'Sonoff', cat: 'control', link: 'matter', eco: ALL, power: 'cableado', price: [420, 620], tier: 'esencial', pitch: 'Atenúa la luz que ya está instalada, sin cambiar la luminaria ni los focos por unos inteligentes.', detalle: 'Sirve cuando ya hay LED atenuable en el techo y no vale la pena cambiarla. Hay que verificar que el driver del LED sea atenuable, si no parpadea.' },
  { id: 'sonoff-minirbs', name: 'MINI RBS · cortina', brand: 'Sonoff', cat: 'cortinas', link: 'matter', eco: ALL, power: 'cableado', price: [480, 720], tier: 'esencial', pitch: 'Convierte una cortina o persiana de motor tonto en una automatizada, sin cambiar el motor.', detalle: 'Va dentro del registro del motor. Aprende el recorrido y ya se puede pedir "a la mitad", que es lo que de verdad se usa.' },
  { id: 'sonoff-mini-pm', name: 'MINI PM · medición', brand: 'Sonoff', cat: 'energia', link: 'matter', eco: ALL, power: 'cableado', price: [380, 560], tier: 'esencial', pitch: 'Mide cuánto consume un circuito. Es como se descubre qué se está comiendo el recibo de luz.', detalle: 'Se pone en el registro del circuito que se quiera medir. Con dos o tres, en un mes se sabe si el gasto es el minisplit o el boiler eléctrico.' },
  { id: 'sonoff-m5', name: 'SwitchMan M5-120 Matter', brand: 'Sonoff', cat: 'control', link: 'matter', eco: ALL, power: 'cableado', price: [311, 359], tier: 'esencial', pitch: 'Apagador de pared completo, con botón mecánico de verdad. Para cuando conviene cambiar la placa en vez de esconder un módulo.', detalle: 'Botón físico con clic: apaga y prende aunque se caiga el internet, que es la objeción número uno del cliente. Uno, dos o tres canales. Necesita neutro.' },
  { id: 'sonoff-t6-120m', name: 'T6-120M táctil Matter', brand: 'Sonoff', cat: 'control', link: 'matter', eco: ALL, power: 'cableado', price: [352, 373], tier: 'esencial', pitch: 'Apagador de pared táctil que habla Matter directo. Chalupa mexicana, sin app aparte y sin puente: se ve como un apagador bonito y responde a los tres asistentes.', detalle: 'Placa de vidrio con uno o dos toques, retroiluminados para encontrarlos de noche. Matter sobre WiFi, así que entra a Apple, Google y Alexa sin hub. Medida 120 —la chalupa rectangular de aquí—, no la europea. NECESITA NEUTRO en la caja: si no hay, la pieza correcta es el ZBMINI L2. Reemplaza la placa existente, así que en departamento rentado hay que guardar la vieja para devolverla al salir.' },
  { id: 'sonoff-s60-matter', name: 'S60 Matter · enchufe', brand: 'Sonoff', cat: 'energia', link: 'matter', eco: ALL, power: 'enchufe', price: [260, 390], tier: 'esencial', pitch: 'El enchufe inteligente barato que sí habla Matter. Para lámpara de piso, cafetera o el árbol de navidad.', detalle: 'Matter sobre WiFi. Mide consumo en la versión PM. Es la pieza con la que se empieza cuando el cliente quiere probar antes de comprometerse.' },
  /* ── cable y acomodo ──────────────────────────────────────────
     Lo que no es inteligente y resuelve igual. Media casa no necesita un
     enchufe de doscientos pesos para prender una lámpara: necesita que el
     cable llegue y que no se vea. Este material entra a la cotización como
     entra todo lo demás, con su precio, porque es lo que de verdad se compra
     y porque no siempre se consigue el día de la obra.

     Ninguno cobra instalación propia: se pone dentro del acomodo de cable,
     que ya se cobra por punto. */
  { id: 'multicontacto-6', name: 'Multicontacto 6 tomas con supresor', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'enchufe', price: [229, 390], tier: 'esencial', pitch: 'Seis contactos donde había uno, con protección contra picos. Es la respuesta honesta cuando el cliente no quiere un aparato inteligente para cada cosa: no todo tiene que prenderse por voz.', detalle: 'Supresor de sobretensiones de verdad, no una barra con más agujeros: eso es lo que protege la tele y la consola de los picos de la CFE. Va donde se juntan tres o cuatro aparatos que se quedan prendidos —el mueble de la tele, el escritorio, el buró— y ahí un enchufe inteligente no aporta nada porque nadie apaga ese circuito. Se cotiza junto con el acomodo de cable, que es lo que hace que no se vea.' },
  { id: 'adaptador-3-vias', name: 'Adaptador plano de 3 vías con clavija plegable', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'enchufe', price: [85, 171], tier: 'esencial', pitch: 'Va en cada contacto de la casa. Un contacto da dos tomas y siempre hacen falta tres, y su clavija se pliega: eso es lo que permite que el sofá quede pegado al muro en vez de a diez centímetros por culpa de un cable doblado.', detalle: 'Seis punto seis por cuatro punto tres centímetros y catorce milímetros de espesor: entra detrás de un mueble sin que se note. La clavija gira 180 grados y se pliega contra el cuerpo, así que el cable sale hacia el lado que convenga —arriba, abajo o de canto— en vez de salir siempre perpendicular al muro, que es lo que obliga a separar los muebles. Tres tomas de dos patas; la versión con tierra física cuesta el doble y se usa donde va la tele o la computadora. Se compra por Amazon Estados Unidos, así que hay que sumarle el envío y una semana de espera; conviene pedirlo con tiempo y de a varios.' },
  { id: 'extension-uso-rudo', name: 'Extensión de uso rudo 5 m', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'enchufe', price: [180, 340], tier: 'esencial', pitch: 'Cinco metros de cable grueso para llegar al contacto que quedó del otro lado del cuarto. La pieza más aburrida del catálogo y la que salva más instalaciones.', detalle: 'Calibre 14 o 16 con tierra física: la extensión delgada del súper se calienta y no lleva tierra, que es justo lo que necesita la tele. Se pide de 5 m porque de 3 nunca alcanza y de 10 sobra cable que hay que esconder. Va por rodapié o por canaleta; suelta en el piso es con lo que la gente se tropieza.' },
  { id: 'canaleta-adhesiva', name: 'Canaleta adhesiva con tapa · 1 m', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'ninguna', price: [55, 110], tier: 'esencial', pitch: 'El metro de canaleta que convierte un cable colgando en una línea recta pegada al muro. Se pinta del color de la pared y desaparece.', detalle: 'Se pega con la cinta que ya trae y se refuerza con dos taquetes si el muro es de tabla-roca. Se corta con segueta y se pinta con la misma pintura del cuarto: bien puesta, a un metro de distancia no se ve. Es reversible, que es lo que la hace la opción correcta en departamento rentado. Se cotiza por metro y la mano de obra va en el acomodo.' },
  { id: 'clips-cable', name: 'Grapas adhesivas para cable · 20 pzas', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'ninguna', price: [70, 140], tier: 'esencial', pitch: 'Veinte grapas de pegar para llevar un cable por el filo del rodapié o por atrás de un mueble sin clavar nada.', detalle: 'Para el cable suelto que no justifica canaleta: el de una tira LED, el de un sensor, el que baja de la tele. Se pegan cada 20 o 30 cm siguiendo una línea recta —es la línea recta lo que hace que se vea intencional y no improvisado—. En muro pintado se despegan sin levantar pintura si se calientan tantito.' },
  { id: 'velcro-cable', name: 'Cinchos de velcro · 10 pzas', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'ninguna', price: [60, 120], tier: 'esencial', pitch: 'Para recoger el cable que sobra en vez de dejarlo enredado atrás del mueble. Se abren y se vuelven a cerrar las veces que haga falta.', detalle: 'Velcro y no cincho de plástico: el de plástico se corta una vez y ya, y en una casa los cables se mueven. Se usa para el rollo de cable sobrante del eliminador, que es de donde sale la mitad del desorden que se ve al mover un mueble.' },
  { id: 'pasacables-piso', name: 'Pasacables de piso · 1.5 m', brand: 'Genérico', cat: 'cableado', link: 'ninguno', eco: ALL, power: 'ninguna', price: [280, 520], tier: 'esencial', pitch: 'La rampa de hule para cuando el cable tiene que cruzar por donde se camina y no hay de otra.', detalle: 'Cuando el contacto quedó de un lado y el aparato del otro, y no se puede rodear por la pared. Es fea y es lo correcto: un cable cruzando un paso es con lo que se tropieza alguien, y en casa con niños o perro no es negociable. Antes de cotizarla vale la pena ver si mover el mueble medio metro resuelve el problema gratis.' },

  { id: 'kasa-kp303', name: 'Kasa KP303 · regleta de 3 tomas', brand: 'TP-Link Kasa', cat: 'energia', link: 'wifi', eco: ['alexa', 'google', 'ha'], power: 'enchufe', price: [627, 627], tier: 'esencial', pitch: 'Tres contactos que se prenden y apagan por separado, más dos USB, en una sola regleta con protección contra picos. Para el buró, el escritorio o el mueble de la tele, donde hay tres cosas y un solo enchufe.', detalle: 'Cada toma se controla por su cuenta desde el teléfono o por voz, así que una regleta resuelve tres aparatos por el precio de un enchufe y medio. Trae supresor de picos, que en un mueble con tele y consola no es un extra. WiFi 2.4 GHz, sin Matter. Es de las piezas mejor calificadas de su categoría y de TP-Link, así que entra por el mismo distribuidor que el resto de su línea.' },
  { id: 'enchufe-matter-15a', name: 'Enchufe Matter 15 A (pack de 4)', brand: 'Genérico Matter', cat: 'energia', link: 'matter', eco: ALL, power: 'enchufe', price: [165, 212], tier: 'esencial', pitch: 'El enchufe inteligente más barato que sí está certificado Matter. Comprado de a cuatro sale en la mitad de lo que cuesta uno de marca, y hace exactamente lo mismo: prender, apagar y programar lo que sea que esté conectado.', detalle: 'Matter sobre WiFi 2.4 GHz: entra a Apple, Google, Alexa y SmartThings sin puente ni app aparte. Se compra en paquete de cuatro —a 157 el enchufe— y de a uno no tiene sentido. El precio de arriba del rango es el mismo enchufe de marca conocida (Linkind) por si el cliente quiere respaldo con nombre; la diferencia es el logo y la garantía, no la función. Ojo con el tamaño: los enchufes gordos tapan el segundo contacto del dúplex, y en un buró donde ya hay un cargador eso molesta.' },
  { id: 'sonoff-nspanel-pro', name: 'NSPanel Pro', brand: 'Sonoff', cat: 'hubs', link: 'wifi', eco: ALL, power: 'cableado', price: [2074, 2374], tier: 'casa', pitch: 'Pantalla táctil de pared que además hace de puente Zigbee. Va donde iba el apagador del pasillo y se vuelve el tablero de la casa.', detalle: 'Reemplaza una placa doble. Controla escenas con el dedo sin sacar el teléfono, que es lo que hace que la casa se use de verdad. Como puente Zigbee ahorra comprar otro aparato.' },
  { id: 'sonoff-ihost', name: 'iHost · hub local', brand: 'Sonoff', cat: 'hubs', link: 'cable', eco: ALL, power: 'corriente', price: [2600, 3900], tier: 'casa', pitch: 'El cerebro que corre en la casa y no en la nube: si se cae el internet, las automatizaciones siguen.', detalle: 'Zigbee integrado, controlador y puente Matter. Para el cliente que pregunta qué pasa si la empresa cierra o si sube el precio de una suscripción: aquí nada depende de un servidor ajeno.' },
  { id: 'sonoff-zbbridge-u', name: 'Zigbee Bridge Ultra', brand: 'Sonoff', cat: 'hubs', link: 'wifi', eco: ALL, power: 'enchufe', price: [890, 1350], tier: 'esencial', pitch: 'Puente Zigbee que se presenta como Matter: mete todos los sensores baratos a Apple, Google o Alexa de una sola vez.', detalle: 'Es la pieza que hace viable la estrategia de sensores económicos. Sin él, cada sensor Zigbee necesita que el hub del ecosistema traiga radio Zigbee, y varios no la traen.' },
  { id: 'sonoff-snzb-03p', name: 'SNZB-03P · movimiento', brand: 'Sonoff', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'pila', price: [180, 290], tier: 'esencial', pitch: 'Sensor de movimiento de pila que cuesta lo que una comida. Con puente Zigbee, el más barato que sirve.', detalle: 'Detecta movimiento, no presencia: si te quedas quieto leyendo, se apaga. Para pasillo, clóset y escalera es perfecto; para sala hay que ir a un sensor de presencia de verdad.' },
  { id: 'sonoff-snzb-04p', name: 'SNZB-04P · puerta', brand: 'Sonoff', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'pila', price: [160, 260], tier: 'esencial', pitch: 'Sensor de contacto para puerta, ventana o el clóset que prende su luz al abrirse.', detalle: 'Pila de años. Es el disparador más confiable que hay: no falla como el de movimiento porque no interpreta nada, solo sabe si está abierto o cerrado.' },
  { id: 'sonoff-snzb-02p', name: 'SNZB-02P · temperatura', brand: 'Sonoff', cat: 'clima', link: 'zigbee', eco: ALL, power: 'pila', price: [192, 192], tier: 'esencial', pitch: 'Temperatura y humedad por cuarto, para que el minisplit y el humidificador se disparen con el dato y no con el reloj.' },
  { id: 'sonoff-snzb-05p', name: 'SNZB-05P · fuga de agua', brand: 'Sonoff', cat: 'agua', link: 'zigbee', eco: ALL, power: 'pila', price: [200, 320], tier: 'esencial', pitch: 'Se pone en el piso bajo la tarja, el boiler o la lavadora y avisa antes de que el agua llegue al vecino de abajo.', detalle: 'En departamento es la pieza que más barato evita el problema más caro. Va en zotehuela y bajo lavabo.' },
  { id: 'sonoff-dongle-max', name: 'Dongle Max · Zigbee + Thread', brand: 'Sonoff', cat: 'hubs', link: 'cable', eco: ALL, power: 'corriente', price: [520, 780], tier: 'esencial', pitch: 'Para el cliente que corre Home Assistant: una sola antena para Zigbee y Thread.', detalle: 'Solo tiene sentido con un servidor detrás. En una casa sin Home Assistant, el puente o el iHost resuelven mejor.' },
  { id: 'sonoff-garage', name: 'Controlador de portón', brand: 'Sonoff', cat: 'acceso', link: 'wifi', eco: ALL, power: 'cableado', price: [174, 174], tier: 'esencial', pitch: 'Abre el portón desde el teléfono y avisa si quedó abierto. Se conecta al motor que ya está.', detalle: 'Incluye sensor de posición, que es lo que hace útil el aviso. Sin él solo sabes que mandaste la orden, no si de verdad cerró.' },

  /* ── lo que faltaba para surtir una casa completa con Sonoff ── */
  { id: 'tapo-l930', name: 'Tapo L930-5 · tira RGBW 5 m', brand: 'TP-Link Tapo', cat: 'iluminacion', link: 'wifi', eco: ['alexa', 'google', 'ha'], power: 'corriente', price: [801, 801], tier: 'esencial', luz: { lm: 1000, k: [2500, 6500], haz: 120, forma: 'lineal' }, pitch: 'Cinco metros de luz de color que además hacen blanco de verdad, para cornisa, bajo gabinete o detrás de la tele. Es la tira que sí se consigue aquí y con quien reclamarle.', detalle: 'RGBW por segmentos: además de color trae un LED blanco aparte, que es lo que la hace servir para iluminar y no nada más para decorar. WiFi 2.4 GHz y Bluetooth para el emparejamiento. Se corta cada 10 cm y se extiende con tramos que se compran aparte. NO habla Matter todavía. Se prefiere sobre la Sonoff L3 Pro por una razón de abasto: TP-Link tiene distribución formal en México y la L3 Pro sólo se consigue por vendedores de marketplace.' },
  { id: 'sonoff-b05-bl', name: 'B05-BL · foco RGB', brand: 'Sonoff', cat: 'iluminacion', link: 'wifi', eco: ALL, power: 'corriente', price: [190, 290], tier: 'esencial', luz: { lm: 806, k: [2700, 6500], haz: 180, forma: 'punto' }, pitch: 'Foco de color a una quinta parte de lo que cuesta un Hue. Rosca E27 normal, 806 lúmenes, 2700 a 6500 K.', detalle: 'WiFi, no Zigbee ni Thread: cada foco ocupa un lugar en la red, así que con más de ocho o diez conviene tener malla. No tiene la fidelidad de color de Hue —los tonos pastel salen menos limpios— pero en un cuarto donde la luz es ambiente y no protagonista, la diferencia no se nota y el ahorro sí.' },
  { id: 'sonoff-b02-bl', name: 'B02-BL · foco blanco', brand: 'Sonoff', cat: 'iluminacion', link: 'wifi', eco: ALL, power: 'corriente', price: [150, 230], tier: 'esencial', luz: { lm: 806, k: [2700, 6500], haz: 180, forma: 'punto' }, pitch: 'El mismo foco sin color: blanco cálido a frío, atenuable. Para baño, pasillo y clóset, donde el RGB no aporta nada.' },
  { id: 'sonoff-l3-pro', name: 'L3 Pro · tira RGBIC 5 m', brand: 'Sonoff', cat: 'iluminacion', link: 'wifi', eco: ALL, power: 'corriente', price: [520, 780], tier: 'esencial', luz: { lm: 900, k: [2700, 6500], haz: 120, forma: 'lineal' }, pitch: 'Tira de luz direccionable: cada tramo puede ir de un color distinto. Para bajo gabinete, atrás de la tele o el nicho de la cafetera.', detalle: 'RGBIC quiere decir que el degradado corre a lo largo de la tira en vez de pintarla toda igual. Se corta a la medida. Comparada con la Hue Lightstrip cuesta un tercio y el adhesivo es más débil: en cocina conviene reforzar con perfil de aluminio.' },
  { id: 'sonoff-cam-gk', name: 'GK-200MP2-B · cámara 360°', brand: 'Sonoff', cat: 'camaras', link: 'wifi', eco: ['alexa', 'google', 'ha'], power: 'corriente', price: [780, 1150], tier: 'esencial', pitch: 'Cámara de interior que gira 340°, con visión nocturna y audio en dos vías. Tiene puerto Ethernet, que es lo que la vuelve confiable.', detalle: 'Se consigue en Unit Electronics, aquí en el Centro. Graba a microSD local sin suscripción. No entra a Apple Home —solo Alexa, Google y Home Assistant—, así que en casa de puro iPhone hay que decirlo antes.' },
  { id: 'nfc-tags', name: 'Etiquetas NFC para escenas', brand: 'Genérico', cat: 'control', link: 'ninguno', eco: ALL, power: 'ninguna', price: [180, 320], tier: 'esencial', pitch: 'Calcomanías que disparan una escena al acercarles el teléfono. Una en la entrada, una en el buró: se toca y la casa cambia.', detalle: 'Paquete de diez, NTAG215. Funcionan con los Atajos del iPhone y con Alexa o Google en Android. No necesitan pila ni red — es el control más barato que existe y el que más se usa cuando se pone en el lugar correcto. Se programan en la puesta en marcha.' },
  { id: 'regleta-smart', name: 'Regleta inteligente 4 tomas', brand: 'Genérico', cat: 'energia', link: 'wifi', eco: ALL, power: 'enchufe', price: [498, 873], tier: 'esencial', pitch: 'Cuatro contactos que se prenden y apagan por separado, más dos USB. Resuelve un escritorio o un mueble de tele con un solo aparato.', detalle: 'Sonoff no fabrica regletas: esta es de marca genérica con Matter o Tuya según el modelo que haya. Conviene verificar que diga Matter en la caja, no solo en la ficha. Donde el cliente quiera solo un enchufe controlado, sale más barato y más confiable el S60 de Sonoff.' },
  { id: 'gas-detector-lp', name: 'Detector de gas LP', brand: 'Genérico', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'corriente', price: [450, 850], tier: 'esencial', pitch: 'Para casa con tanque o gas estacionario. Va cerca de la estufa y A RAS DE PISO: el gas LP pesa más que el aire y se acumula abajo.', detalle: 'DÓNDE VA: a menos de metro y medio de la estufa y a unos 30 cm del piso. Cerca porque es el punto donde alguien deja una perilla abierta; bajo porque el LP baja. Y NO directamente encima de los quemadores — el vapor y el calor de cocinar disparan falsas alarmas y le acortan la vida al sensor. Necesita contacto cerca: se enchufa, no es de pila. OJO: no es intercambiable con el de gas natural. El LP (del tanque) baja; el natural (de tubería) sube. Un detector a la altura equivocada nunca se dispara, y eso es peor que no tenerlo porque da tranquilidad falsa. Sonoff no fabrica detectores de gas; se resuelve con Zigbee genérico y puente.' },
  { id: 'gas-detector-nat', name: 'Detector de gas natural', brand: 'Genérico', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'corriente', price: [450, 850], tier: 'esencial', pitch: 'Para vivienda con gas de tubería. Va ALTO, cerca del plafón: el metano es más ligero que el aire y sube.', detalle: 'Antes de cotizar hay que confirmar qué gas hay en la vivienda. En la Ciudad de México conviven los dos y la altura de montaje se decide con esa respuesta, no antes.' },
  { id: 'valvula-gas', name: 'Válvula de corte de gas', brand: 'Especialidad', cat: 'sensores', link: 'zigbee', eco: ALL, power: 'corriente', price: [2400, 4200], tier: 'casa', pitch: 'Cierra el paso del gas sola cuando el detector se dispara. Es la pieza que convierte una alarma en una protección.', detalle: 'SEGURIDAD: tiene que ser una válvula certificada PARA GAS. La válvula de agua de Sonoff (SWV) es de riego y NO sirve aquí — usarla sería peligroso. La instala quien tenga la certificación para gas, no nosotros; nosotros dejamos la automatización y la integración. En vivienda rentada se necesita permiso del propietario porque toca la instalación fija.' },

  /* ── alarma sonora ─────────────────────────────────────────────
     Sí existen sirenas inteligentes de fábrica, así que no hay que armar
     nada — pero la opción armada entra igual porque en México la sirena
     Zigbee de marca hay que importarla y la combinación sale el mismo día.

     Lo que NO es negociable en ninguna de las dos: el relevador va FUERA de
     la cocina. Cerrar un contacto es hacer una chispa, y hacerla justo donde
     se está acumulando el gas es lo contrario de una alarma. Va en el pasillo
     o en la recámara, que además es donde tiene que oírse para despertar a
     alguien a las tres de la mañana. */
  { id: 'sirena-zigbee', name: 'Sirena Zigbee 105 dB', brand: 'Heiman', cat: 'acceso', link: 'zigbee', eco: ALL, power: 'corriente', price: [850, 1600], tier: 'esencial', pitch: 'Sirena de interior que entra a la casa como un dispositivo más: se dispara desde cualquier automatización, no solo desde una alarma de marca.', detalle: 'Zigbee, necesita puente. Trae respaldo de pila para que siga sonando si alguien corta la luz. 105 dB despierta a toda la casa. Se importa: en México no se consigue en mostrador, hay que pedirla.' },
  { id: 'sirena-armada', name: 'Sirena armada con enchufe inteligente', brand: 'Matter México', cat: 'acceso', link: 'matter', eco: ALL, power: 'enchufe', price: [520, 900], tier: 'esencial', propio: true, pitch: 'Una sirena de 127 V de las de siempre, enchufada a un contacto inteligente. Cualquier automatización la prende, y se consigue completa el mismo día en el Centro.', detalle: 'Sirena piezoeléctrica de 110 dB más un Sonoff S60 Matter. Sale la mitad que la Zigbee de marca y no hay que importar nada. DÓNDE VA: el enchufe FUERA del cuarto donde puede haber gas — pasillo o recámara. Cerrar el relevador hace chispa, y hacerla donde se acumula el gas es exactamente lo que no se quiere. De paso es donde tiene que oírse: la sirena de la cocina no despierta a nadie que duerma con la puerta cerrada.' },

  /* ── lo levantado en Departamento Margay ──────────────────────
     Piezas reales con su modelo. El campo `matter` es lo que interesa aquí:
     dice si el aparato habla Matter de fábrica, si puede llegar a hablarlo por
     una actualización, o si no va a llegar nunca. Eso decide si se conserva o
     se cambia, que es la conversación más cara del levantamiento. */
  { id: 'nanoleaf-nl22', name: 'Light Panels · Aurora (NL22)', brand: 'Nanoleaf', cat: 'iluminacion', link: 'wifi', eco: ALL, power: 'corriente', price: [0, 0], tier: 'esencial', luz: { lm: 900, k: [1200, 6500], haz: 120, forma: 'panel' }, matter: { estado: 'no', porque: 'Generación descontinuada en 2022. Nanoleaf llevó Matter a las líneas Shapes y Essentials, no a los paneles Aurora: no hay ruta de firmware.', accion: 'Se conservan y se controlan por su app o por HomeKit/Alexa como estaban. No van a aparecer junto al resto de la casa en Matter. Cuando se quieran integrar de verdad, se cambian por Shapes.' }, pitch: 'Los paneles triangulares originales. Siguen funcionando perfecto; lo que no hacen es hablar Matter.', detalle: 'Modelo NL22-0017TW-9PK, kit de nueve. Se unen por conectores rígidos y admiten muchas composiciones distintas sobre el muro.' },
  { id: 'orein-a19-matter', name: 'Foco A19 Matter (OS0100811267)', brand: 'OREIN', cat: 'iluminacion', link: 'matter', eco: ALL, power: 'corriente', price: [122, 179], tier: 'esencial', luz: { lm: 800, k: [1800, 6500], haz: 180, forma: 'punto', rgb: true }, matter: { estado: 'fabrica', porque: 'Matter sobre WiFi de fábrica.' }, pitch: 'Foco Matter RGBCW barato que entra directo a Apple, Google y Alexa sin puente ni app aparte.', detalle: 'RGBCW: hace color y además blanco regulable de 1800 a 6500 K, que es lo que de verdad se usa a diario. Matter sobre WiFi, así que cada foco ocupa un lugar en la red; con más de ocho conviene malla, que en este departamento ya la hay.' },
  { id: 'onvis-sms1', name: 'Smart Motion Sensor SMS1', brand: 'Onvis', cat: 'sensores', link: 'bluetooth', eco: ['apple'], power: 'pila', price: [0, 0], tier: 'esencial', matter: { estado: 'no', porque: 'Sensor de Bluetooth para HomeKit. Onvis sacó su línea Matter sobre Thread aparte —los modelos S4 y siguientes—; el SMS1 no tiene ruta de actualización.', accion: 'Sirve dentro de Apple Home y ahí se queda. Si la casa se arma en Alexa o Google, no entra: hay que cambiarlo.' }, pitch: 'Sensor de movimiento, temperatura y humedad de pila. Solo Apple Home.', detalle: 'Alcance corto de Bluetooth: pide un hub de Apple cerca. Detecta movimiento, no presencia — si te quedas quieto, se apaga.' },
  { id: 'eve-dimmer', name: 'Eve Dimmer Switch (2EL304001000)', brand: 'Eve', cat: 'control', link: 'thread', eco: ['apple'], power: 'cableado', price: [1400, 1900], tier: 'casa', matter: { estado: 'revisar', porque: 'Eve subió a Matter por firmware gratis varios de sus aparatos —Energy, Door & Window, Light Switch, Motion, Thermo, Weather— pero el Dimmer Switch NO aparece en su lista oficial de elegibles.', accion: 'Confirmar con Eve antes de prometerlo. Si no entra, sigue funcionando en Apple Home por Thread, que es donde está. OJO: la actualización a Matter de Eve es de un solo sentido, no se puede regresar a HomeKit.' }, pitch: 'Atenuador de pared que habla Thread. Botón físico de verdad: apaga y prende aunque se caiga el internet.', detalle: 'Necesita neutro. Refuerza la malla Thread de la casa por estar siempre alimentado.' },
  { id: 'echo-spot-2024', name: 'Echo Spot (BV84J9)', brand: 'Amazon', cat: 'av', link: 'wifi', eco: ['alexa'], power: 'corriente', price: [1200, 1800], tier: 'esencial', matter: { estado: 'fabrica', porque: 'Controlador Matter de fábrica.', accion: 'No es puente Zigbee ni router de borde Thread: para eso hace falta un Echo grande de 4ª generación o un Echo Hub.' }, pitch: 'Reloj despertador con pantalla y Alexa. En el buró es donde más se usa la voz de toda la casa.', detalle: 'Adopta aparatos Matter y los controla por voz. No arma malla Thread.' },
  { id: 'appletv-a2169', name: 'Apple TV 4K 2ª gen · 64 GB (A2169)', brand: 'Apple', cat: 'hubs', link: 'thread', eco: ['apple'], power: 'corriente', price: [3200, 4200], tier: 'casa', matter: { estado: 'fabrica', porque: 'Central de Apple Home, controlador Matter y router de borde Thread.', accion: 'Sirve tal cual. Va cableado por Ethernet si se puede: la malla Thread se porta mejor con la central cableada.' }, pitch: 'La central de la casa que además es la tele. El A2169 de 2021 sí trae radio Thread, con 32 o con 64 GB.', detalle: 'OJO con la confusión: el que NO trae Thread es el de 3ª generación de 64 GB solo WiFi. En la 2ª generación las dos capacidades lo traen.' },
  { id: 'amazon-plug-hd34bx', name: 'Smart Plug (HD34BX)', brand: 'Amazon', cat: 'energia', link: 'wifi', eco: ['alexa'], power: 'enchufe', price: [350, 550], tier: 'esencial', matter: { estado: 'revisar', porque: 'Amazon ha ido subiendo Matter a parte de su línea de enchufes por firmware, pero no en todos los lotes ni regiones.', accion: 'Revisar en la app de Alexa si ofrece actualización. Si no la trae, sigue funcionando solo dentro de Alexa — que es donde está.' }, pitch: 'Enchufe inteligente de Amazon. Se empareja solo con cualquier Echo cerca.', detalle: 'Sin medición de consumo. Su gracia es lo fácil que entra a Alexa.' },
  { id: 'tplink-deco-x50', name: 'Deco X50 · WiFi 6 en malla', brand: 'TP-Link', cat: 'red', link: 'cable', eco: ALL, power: 'corriente', price: [2600, 3800], tier: 'casa', matter: { estado: 'fabrica', porque: 'Varios Deco hacen de controlador Matter y algunos de router de borde Thread, según modelo y firmware.', accion: 'Aunque no cuente como hub, la malla es lo que sostiene todo lo Matter sobre WiFi. Aquí es la pieza más importante de la casa.' }, pitch: 'AX3000 en malla, hasta 600 m² con tres nodos. Es lo que hace que treinta aparatos no se caigan.', detalle: 'Kit de tres: uno por espacio grande. Deja poner una banda de 2.4 GHz con nombre propio para el IoT, que resuelve la mitad de los problemas de emparejamiento.' },
]
...
/* Un rango con los dos extremos iguales no es un rango: es un precio que ya se
   validó contra la lista de un proveedor. Enseñarlo como "$221–$221" lo hace
   ver a error de captura, justo cuando es el dato más confiable que tenemos. */
export const hayRango = (d) => d.price[0] !== d.price[1]
